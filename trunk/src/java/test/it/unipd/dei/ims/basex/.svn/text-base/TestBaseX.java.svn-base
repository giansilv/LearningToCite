...
public class TestBaseX {
	...
	private static File eadFile = new File("/Users/silvello/Documents/EAD_collections/LoC2014_groundTruth/" + name + ".xml");

	private static String human_reference = "/Users/silvello/Documents/EAD_collections/LoC2014_groundTruth_human_ref/" + name + "-0-human.txt";
